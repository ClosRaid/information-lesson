...
def select_1():
    ...
    query = "SELECT CategoryName FROM customers;"
...
def select_2():
    ...
    # ❗ СТУДЕНТ ПИШЕТ ЗАПРОС ЗДЕСЬ
    query = "SELECT DISTINCT ContactTitle FROM Customers;"
...
def select_3():
    ...
    # ❗ СТУДЕНТ ПИШЕТ ЗАПРОС ЗДЕСЬ
    query = "SELECT city FROM Customers ORDER BY city;"
...
def select_4():
    ...
    # ❗ СТУДЕНТ ПИШЕТ ЗАПРОС ЗДЕСЬ
    query = "SELECT ContactTitle FROM Customers WHERE ContactTitle = 'Owner';"
...
def select_5():
    ...
    # ❗ СТУДЕНТ ПИШЕТ ЗАПРОС ЗДЕСЬ
    query = "SELECT ContactTitle FROM Customers Where ContactTitle = 'Sales Representative' LIMIT 5;"
